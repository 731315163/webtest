...
import sty from "./PlasmicButton.module.css"; // plasmic-import: mBCV2aoiFx1/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 6s4jVVJaTo9/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: -IbdzahjrwZ/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__w1CR)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__zTNji)}
                role={"img"}
              />
            ),
